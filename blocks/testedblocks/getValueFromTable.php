<!--
Сам блок должен был получать таблицу, показывать ее прямо на странице,
а по нажатии на кнопку в дополнительной колонке значение должно было отправиться назад
но у меня для таких много ходов очков нет времени,
по этому это я оставлю на дальнейшую (да_серьезно_ебало.пнг) разработку
-->
